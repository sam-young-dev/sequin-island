...
**Unresolved:** (2026-09-24: until FOSILS confirms, the page treats the newest statement as current, so passengers land on the small beach until the pier is finished and all "dock" wording is gone.) **first, because the tide band could shade it once known:** which part of the tide cycle closes the beach landing; then the caretaker season end (Labor Day vs Columbus Day); the dock tie-up rule once the pier is finished; whether the ferry operator is current.
